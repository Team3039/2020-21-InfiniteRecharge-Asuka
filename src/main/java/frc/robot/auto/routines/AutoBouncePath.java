...
public class AutoBouncePath extends SequentialCommandGroup {
  ...
  public AutoBouncePath() {
      addCommands(
              ...
              new RamseteCommand(
                mTrajectories.getBounceStartToFirstBall(),
                mDrive::getPose,
    ...
    new StopTrajectory(),
    new RamseteCommand(
                mTrajectories.getFirstBallToSecondTrench(),
                mDrive::getPose,
                new RamseteController(Constants.kRamseteB, Constants.kRamseteZeta),
                new SimpleMotorFeedforward(Constants.ksVolts,
                        Constants.kvVoltSecondsPerMeter,
    ...
    new StopTrajectory(),
    new RamseteCommand(
        mTrajectories.getSecondBallToThirdTrench(),
        mDrive::getPose,
        new RamseteController(Constants.kRamseteB, Constants.kRamseteZeta),
        new SimpleMotorFeedforward(Constants.ksVolts,
                Constants.kvVoltSecondsPerMeter,
...
new StopTrajectory(),
new RamseteCommand(
        mTrajectories.getThirdBallToFinalPose(),
        mDrive::getPose,
        new RamseteController(Constants.kRamseteB, Constants.kRamseteZeta),
        new SimpleMotorFeedforward(Constants.ksVolts,
                Constants.kvVoltSecondsPerMeter,
